...
const RestoreMusics = (props: Props) => {
  ...
  const actionRestoreMusics = () => {
    setSpinLoader(true);
    musicService
      .restoreMusics(props.musics)
      .then((res) => {
        toast.current.show({
          severity: 'success',
        ...
        <div className="p-fluid p-formgrid p-grid">
          <div className="p-field p-col-12">
            ...
            {props.musics.map((music) => {
              return (
                <li key={music.id} className="p-m-2">
